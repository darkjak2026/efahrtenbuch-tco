  ...
  return (
    ...
    >
      ...
      <circle
        ...
        transform={`rotate(-90 ${CENTER} ${CENTER})`}
      />
      <circle cx={minutesHandle.x} cy={minutesHandle.y} r={9} fill="var(--glacier-deep)" stroke="#fff" strokeWidth={2} />
      <circle cx={hoursHandle.x} cy={hoursHandle.y} r={9} fill="var(--plum)" stroke="#fff" strokeWidth={2} />
      <text x={CENTER} y={CENTER - 3} textAnchor="middle" className="duration-dial-value">
        {hours}h {minutes}m
      </text>
      <text x={CENTER} y={CENTER + 15} textAnchor="middle" className="duration-dial-caption">
        ⏳ Ladedauer
      </text>
    </svg>
  );
